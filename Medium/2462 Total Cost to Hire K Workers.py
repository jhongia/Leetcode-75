...
#         totalCost = 0
#         for i in range(k):
#             first = min(costs[:candidates])
#             last = min(costs[-candidates:])
#             print(first)
#             print(last)
#             minCostIdx = costs.index(min(first, last))
#             totalCost += costs.pop(minCostIdx)
#             print("Costs: ", costs)
#             print("I: ", i)
...
sol = Solution()
print(sol.totalCost(costs, k, candidates)) #11